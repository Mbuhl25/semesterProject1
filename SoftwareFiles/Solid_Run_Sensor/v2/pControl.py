...
class pController():
    def __init__(self, kp = 1.2):
        ...
        #self.weights = [1.210,1.003,0.694,0.277,0.293,0.800,0.885,1.339]
        #self.weights = [1210, 1003, 694, 277, 293, 800, 885, 1339]
        #self.weights = [1.210,1.003,0.694,0.800,0.885,1.339]
        #self.weights = [12, 10, 7, 8, 9, 13]
