...
class Roboticmovements:
    ...
    def turndetect(self, direction=1):
        while True:
            ...
            self.turn_degree(1, direction, speed=0.008)
            if self.converted_sen[0] == "2":
                self.turn_degree(25, 1)
                break
            if self.converted_sen[7] == "2":
                self.turn_degree(25, -1, speed=0.008)
                break  
    ...
    def pickup(self):
        ...
        self.magnet(1)
        self.mag_scan()
        self.actutor1.step_motor(0.002, 1280, 1)
        self.magnet(0)
        
    def pickup_right(self):
        self.move_distance(10, -1, speed=0.005)
        self.turn_degree(175, 1, speed=0.005)
        self.move_distance(13, -1, speed=0.005)
        
        self.pickup()       

        self.move_distance(5, 1, speed=0.005)
        self.turn_degree(140, 1, speed=0.005)
        self.turndetect()
        self.move_distance(10, 1, speed=0.005)
    ...
    def pickup_left(self):
        self.move_distance(10, -1, speed=0.005)
        self.turn_degree(170, -1, speed=0.005)
        self.move_distance(13, -1, speed=0.005)
        self.pickup()  
